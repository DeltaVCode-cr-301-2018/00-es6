...
function displayPics(){
  ...
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the variable 
  //declaration from `var to `let`.
  /* when a variable is declared by a 'let' contained in the function, 
    the result, being on the outside of the function, won't recgnize it.
    see fuction displayPics() */
