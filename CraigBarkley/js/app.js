...
function displayPics(){
  ...
  //console.log(rando);
  // TODO: In a sentence or two, explain why the previous line of code threw 
  //an error when we changed the variable declaration from `var to `let`.
  // by declaring rando with let it is scoped to the while loop and the console.log is outside the scope of the //loop. 
  console.log(viewed);
